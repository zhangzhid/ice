...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title><?php echo get_config_value('site_name');?> - 数字营销管理</title>
	...
	$(".left").toggle();
		...
		<div class="right" id="mainFrame">
			<div class="right_cont">
				...
				<div class="title_right"><strong>数字营销查看</strong></div>
				<div style="width:900px;">
					...
					<table class="table table-bordered">
						<tr>
							...
							<td class="text-center"><a href="<?php echo U('add');?>"  class="btn btn-success" style="width:80px;" />增加营销数据</td><!--
					...
					<table class="table table-bordered">
						...
						<?php if($goods_list): if(is_array($goods_list)): foreach($goods_list as $key=>$vo): ?><tr>
									...
									<td align="center"><img src="<?php echo ($vo["z1"]); ?>" width="520px" height="80px"/></td>
									<td align="center">
