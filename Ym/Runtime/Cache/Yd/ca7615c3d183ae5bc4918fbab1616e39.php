...
<title><?php echo get_config_value('site_name');?> - 广告管理</title>
	 ...
	 <div class="logo"><img  src="<?php echo get_config_value('site_logo');?>" /></div>
              ...
              <i class="icon-off icon-white"></i> <a id="modal-973558" href="#modal-container-973558" role="button" data-toggle="modal">退出</a> <i class="icon-user icon-white"></i> <a href="/" target="_blank">网站首页</a>
				...
				<div class="modal-footer">
					 <button class="btn" data-dismiss="modal" aria-hidden="true">关闭</button> <a class="btn btn-primary" style="line-height:20px;" href="/Yd/Ad/logout/" >确定退出</a>
				</div>
			</div>
				</div>
</div>
...
<ul class="breadcrumb">当前位置： 后台管理
   ...
   <div class="title_right"><strong>广告设置</strong></div>
   <div style="width:980px;">
       <table class="table table-bordered table-hover table-striped">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr align="center">
             ...
             <td><?php echo ($v["wz"]); ?></td>
             <td><a href="<?php echo ($v["tp"]); ?>" target="_blank"><?php echo ($v["tp"]); ?></a></td>
             <td><a href="<?php echo ($v["dz"]); ?>" target="_blank"><?php echo ($v["dz"]); ?></a></td>
             <td>
