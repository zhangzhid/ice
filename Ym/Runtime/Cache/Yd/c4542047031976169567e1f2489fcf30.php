...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title><?php echo get_config_value('site_name');?> - 微信数据管理</title>
				...
				<div style="width:900px;">
					...
					<table class="table table-bordered">
						<tr>
							...
							<td class="text-center"><a href="<?php echo U('add');?>"  class="btn btn-success" style="width:80px;" />增加微信数据</td>
							<td class="text-center"><a href="<?php echo U('import');?>" class="btn btn-primary" style="width:80px;" />Excel导入数据</td>
						</tr>
					</table>
					<table class="table table-bordered">
						<tr>
							...
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1">微信ID</td>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1">粉丝量</td>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1">头条报价</td>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1">非头条报价</td>
							<td align="center" nowrap="nowrap" bgcolor="#f1f1f1">阅读数</td>
