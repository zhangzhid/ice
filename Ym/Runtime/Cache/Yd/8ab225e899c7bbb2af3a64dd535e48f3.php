        ...
        <div style="width:650px;">
            <form  action="<?php echo U('/Yd/Wb/save');?>" method="post" enctype="multipart/form-data">
                ...
                <table class="table table-bordered" >
                    ...
                    <tr>
                        <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">微博名称：</td>
                    ...
                    <tr>
                        <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">微博号：</td>
                        <td width="68%"><input type="text" name="w2" value="<?php echo ($goods_info["w2"]); ?>"  datatype="*"  nullmsg="请填写微博号！" />
                    ...
                    <tr>
                        <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">软广报价：</td>
                    ...
                    <tr>
                        <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">硬广报价：</td>
