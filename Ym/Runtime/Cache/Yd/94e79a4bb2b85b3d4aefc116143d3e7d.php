...
<title><?php echo get_config_value('site_name');?> - 微信数据上传</title>
...
<ul class="breadcrumb">当前位置： 后台管理
   ...
   <div class="title_right"><strong>微信数据上传</strong></div>
   ...
   <table  class="margin-bottom-20 table  no-border" >
       ...
       <div class="title_right"><strong>微信数据导出</strong></div>
       <div style="width:900px;">
           <table class="table table-bordered" >
               <tr>
           ...
           <table  class="margin-bottom-20 table  no-border" >
               <tr>
                   <td class="text-center"> <a href="<?php echo U('expUser');?>" class="btn btn-info " style="width:80px;">导出微信数据</a></td>
               </tr>
           </table>
